...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.wordtrap = {}, global.jQuery));
	...
	*/
	...
	function wordtrap_init($wrap) {
	  (function ($) {
	    ...
	    if ($.fn.themeToggle) {
	      $(function () {
	        $wrap.find(".wordtrap-dropdown").each(function () {
	          var $this = $(this);
	          $this.themeToggle($this.data("options"));
	        });
	      });
	    } // WhatsApp sharing
