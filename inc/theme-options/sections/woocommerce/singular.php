...
Redux::set_section(
  ...
  array(
    ...
    'fields'       => array(
      ...
      array(
        'id'       => 'product-extended-columns-start',
        'type'     => 'section',
        'title'    => esc_html__( 'Extended Columns', 'wordtrap' ),
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
        'indent'   => true,
      ),
      array(
        'id'       => 'product-extended-columns-xxl',
        'type'     => 'slider',
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
      ...
      array(
        'id'       => 'product-extended-columns-xl',
        'type'     => 'slider',
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
      ...
      array(
        'id'       => 'product-extended-columns-lg',
        'type'     => 'slider',
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
      ...
      array(
        'id'       => 'product-extended-columns-md',
        'type'     => 'slider',
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
      ...
      array(
        'id'       => 'product-extended-columns-sm',
        'type'     => 'slider',
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
      ...
      array(
        'id'       => 'product-extended-columns-end',
        'type'     => 'section',
        'required' => array( 'product-view', 'equals', array( 'extended' ) ),
        'indent'   => false,
      ),
