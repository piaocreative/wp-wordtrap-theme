...
if ( ! function_exists( 'wordtrap_adjust_body_class' ) ) {
	 ...
	 */
	function wordtrap_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'wordtrap_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function wordtrap_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'wordtrap' ),
		__( 'Previous', 'wordtrap' ),
		__( 'Next', 'wordtrap' ),
		__( 'About:', 'wordtrap' ),
		__( 'Profile', 'wordtrap' ),
		__( 'Posts by', 'wordtrap' ),
		__( 'Permanent Link:', 'wordtrap' ),
		__( 'in', 'wordtrap' ),
		__( 'Edit', 'wordtrap' ),
	);
}
