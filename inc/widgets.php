...
if ( ! function_exists( 'wordtrap_widgets_init' ) ) {
	...
	function wordtrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'wordtrap' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'wordtrap' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'wordtrap' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'wordtrap' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'wordtrap' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'wordtrap' ),
