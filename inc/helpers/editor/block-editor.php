...
if ( ! function_exists( 'wordtrap_generate_color_palette' ) ) {
	...
	function wordtrap_generate_color_palette() {
		...
		$color_palette_json = file_get_contents( get_theme_file_path( '/inc/helpers/editor/editor-color-palette.json' ) ); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents
