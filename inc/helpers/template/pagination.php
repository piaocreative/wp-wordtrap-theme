...
if ( ! function_exists( 'wordtrap_the_posts_navigation' ) ) {
  /**
   ...
   */
  function wordtrap_the_posts_navigation( $args = array(), $class = 'pagination' ) {
    ...
    $args = wp_parse_args(
      ...
      array(
        'mid_size'           => 3,
        'prev_next'          => true,
        'prev_text'          => __( '<i class="fas fa-angle-left"></i>&nbsp;Back', 'wordtrap' ),
        'next_text'          => __( 'Next&nbsp;<i class="fas fa-angle-right"></i>', 'wordtrap' ),
        'type'               => 'array',
