...
add_action( 'woocommerce_before_main_content', 'wordtrap_woocommerce_wrapper_start', 10 );
add_action( 'woocommerce_after_main_content', 'wordtrap_woocommerce_wrapper_end', 10 );

if ( ! function_exists( 'wordtrap_woocommerce_wrapper_start' ) ) {
	/**
	 * Display the theme specific start of the page wrapper.
	 */
	function wordtrap_woocommerce_wrapper_start() {
		$container = get_theme_mod( 'wordtrap_container_type' );
...
if ( ! function_exists( 'wordtrap_woocommerce_wrapper_end' ) ) {
	/**
	 * Display the theme specific end of the page wrapper.
	 */
	function wordtrap_woocommerce_wrapper_end() {
		echo '</main><!-- #main -->';
