...
} // End of if function_exists( 'wordtrap_bootstrap_comment_form_fields' )
...
} // End of if function_exists( 'wordtrap_bootstrap_comment_form' ).
...
if ( ! function_exists( 'wordtrap_comment_form_comments_closed' ) ) {
	...
	function wordtrap_comment_form_comments_closed() {
		if ( get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) {
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'wordtrap' ); ?></p>
			<?php
		}
	}
} // End of if function_exists( 'wordtrap_comment_form_comments_closed' ).
